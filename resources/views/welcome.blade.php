        ...
        <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
            <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
                ...
                <div class="bg-[#fff2f2] dark:bg-[#1D0002] relative lg:-ml-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg aspect-[335/364] lg:aspect-auto w-full lg:w-[438px] shrink-0 overflow-hidden">
                    {{-- Laravel Logo --}}
                    <img src="{{ asset('images/laravel-logo.svg') }}" alt="Laravel Logo" class="w-full transition-all translate-y-0 opacity-100 max-w-none duration-750 starting:opacity-0 motion-safe:starting:translate-y-6" />

                    {{-- Background Art --}}
                    <img src="{{ asset('images/background-art.svg') }}" alt="Background Pattern" class="w-[438px] max-w-none relative -mt-[6.6rem] -ml-8 lg:ml-0 transition-all delay-300 opacity-100 duration-750 starting:opacity-0 motion-safe:starting:translate-x-4" />
